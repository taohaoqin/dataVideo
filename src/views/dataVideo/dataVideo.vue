    ...
    readWorkbookFromLocalFile (file) { // 导入excel表格
      ...
      reader.onload = function (e) {
        ...
        this.wb.SheetNames.forEach((sheetName) => {
          result.push({
            sheet: utils.sheet_to_csv(this.wb.Sheets[sheetName])
          })
        })
